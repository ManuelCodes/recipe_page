        ...
        <>
            <div className="home">
                ...
                <div className="home__title">
                    ...
                    <p>An easy quick dish, perfect for any meal. This classic omelette combines beaten eggs cooked to perfection, optionally filled with your choce of cheese, vegetables, or meats</p>
                </div>
                <div className="home__preparation-time">
                ...
                <hr/>
                <div className="home__nutrition">
                    <h2>Nutrition</h2>
                    <p>The table below shows nutritional values per serving without the additional fillings.</p>
                    <div className="nutrition-table">
                        <div className="nutrition-table__property">Calories</div>
                        <div className="nutrition-table__quantity">277kcal</div>

                        <div className="nutrition-table__property">Carbs</div>
                        <div className="nutrition-table__quantity">0g</div>

                        <div className="nutrition-table__property">Protein</div>
                        <div className="nutrition-table__quantity">20g</div>

                        <div className="nutrition-table__property">Fat</div>
                        <div className="nutrition-table__quantity">22g</div>
                    </div>
